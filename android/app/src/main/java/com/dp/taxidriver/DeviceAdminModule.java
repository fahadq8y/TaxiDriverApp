...
/**
 * DeviceAdminModule - يربط Device Admin بـ React Native
 * 
 * يعرض methods لـ JS:
 * - isAdminActive(): هل Device Admin مفعّل؟
 * - requestAdmin(): اطلب من المستخدم تفعيل Device Admin
 * - openAdminSettings(): افتح إعدادات Device Admin (لإلغاء التفعيل من قبل المدير)
 */
    ...
    public void requestAdmin(Promise promise) {
        try {
            ...
            intent.putExtra(DevicePolicyManager.EXTRA_ADD_EXPLANATION,
                "هذي الحماية تمنع إيقاف التطبيق بالغلط. الرجاء تفعيلها لضمان عمل التتبع. من غير تفعيل هذي الحماية، التتبع ممكن يتوقف من غير علمك.");
